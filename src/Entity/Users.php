...
class Users implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Id]// cella vaut dire que c'est une clé primaire
    ...
    public function __construct()
    {
        ...
        $this->created_at = new \DateTimeImmutable(); // \DateTimeImmutable() : la date en change pas contrairement a DateTime()
    }
